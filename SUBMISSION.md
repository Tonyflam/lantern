...
- [ ] `npm run check` → **lint clean + 42/42 offline checks + 166 tests passing** (one command).
...
| Reproducibility | No build step; `npm install && npm start`; `npm run check` = lint + 42 offline checks + 166 green tests; 0 vulns. |
